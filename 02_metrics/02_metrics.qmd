...
dudi_past <- dudi.pca(climate_past_trans, scale = TRUE, scan = FALSE)
...
# climate data
# present
climate_present_trans <- decostand(data_present_select, "standardize")
dudi_present <- dudi.pca(climate_present_trans, scale = TRUE, scan = FALSE)
