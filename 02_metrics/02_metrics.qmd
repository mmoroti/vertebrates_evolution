...
```{r}
mcmcout <- read.table("02_metrics/BAMM/amphibia/mcmc_out.txt",sep=',', header=T)
head(mcmcout)
...
# setBAMMprior para achar os valores de priors
setBAMMpriors(phy = squamata_phy_ultra, traits = svl_squamata)
...
generateControlFile(file = 'BAMM/squamata/controlfile_squamata.txt', type = 'trait', params = list(
    ...
    numberOfGenerations = '10000',
    overwrite = '1',
    betaInitPrior = '2.28904043293718e-07',
    betaShiftPrior = '0.0059901140275358',
    useObservedMinMaxAsTraitPriors = '1',
    expectedNumberOfShifts = '1.0'))
```
...
# setBAMMprior para achar os valores de priors
setBAMMpriors(phy = birds_phy_ultra, traits = mass_birds)
...
generateControlFile(file = 'BAMM/birds/controlfile_birds.txt', type = 'trait', params = list(
    ...
    numberOfGenerations = '10000',
    overwrite = '1',
    betaInitPrior = '1.28009136772299e-05',
    betaShiftPrior = '0.0113668918251832',
    useObservedMinMaxAsTraitPriors = '1',
    expectedNumberOfShifts = '1.0'))
```
...
# setBAMMprior para achar os valores de priors
setBAMMpriors(phy = mammals_phy_ultra, traits = mass_mammals)
...
```{r} 
#TODO aqui precisamos revisar com o base de traits harmonizadas
```
...
Check MCMC run convergence
```{r}
mcmcout <- read.table("02_metrics/BAMM/amphibia_harm/mcmc_out.txt",sep=',', header=T)
head(mcmcout)
plot(mcmcout$logLik ~ mcmcout$generation)
...
# setBAMMprior para achar os valores de priors
setBAMMpriors(phy = mammals_phy_ultra_harm, traits = mass_mammals_harm)

generateControlFile(file = 'BAMM/mammals_harm/controlfile_mammals.txt', type = 'trait', params = list(
