...
Bio01 <- raster("CHELSA_bio1_1981-2010_V.2.1") # mean annual air temperature
...
###--- Birds
birds_shape <- readOGR("shapefiles/birds.shp")
###--- Mammals
...
# Now, we need to summarise the climate variables per specie
temp_median_mammals <- lets.summarizer2(mammals_temp_median,  pos = 1255:1260, fun = median) 
...
colnames(temp_median_anura_present) <- c("Species", "Bio01_past", "Bio04_past", "Bio07_past",
                                 "Bio11_past", "Bio15_past", "Bio17_past")
...
# Now, we need to summarise the climate variables per specie
temp_median_mammals <- lets.summarizer2(mammals_temp_median,  pos = 1049:1054, fun = median) 
colnames(temp_median_mammals) <- c("Species", "Bio01_past", "Bio04_past", "Bio07_past",
                                 "Bio11_past", "Bio15_past", "Bio17_past")
glimpse(temp_median_squamata)
```
