...
```{r}
mcmcout <- read.table("BAMM/mammals/mcmc_out.txt",sep=',', header=T)
tail(mcmcout)
plot(mcmcout$logLik ~ mcmcout$generation)
...
```{r}
# Creating PresenceAusence object for lets.addvar
path.birds <- system.file("extdata", package = "letsR")
...
# min
temp_min_birds_past <- lets.summarizer2(birds_temp_min_past,  pos = 1049:1054, fun = min) 
colnames(temp_min_birds_present) <- c("Species", "Bio01_past_min", "Bio04_past_min", "Bio07_past_min",
                                 "Bio11_past_min", "Bio15_past_min", "Bio17_past_min")
# max
temp_max_birds_past <- lets.summarizer2(birds_temp_max_past,  pos = 1049:1054, fun = max) 
colnames(temp_max_birds_present) <- c("Species", "Bio01_past_max", "Bio04_past_max", "Bio07_past_max",
                                 "Bio11_past_max", "Bio15_past_max", "Bio17_past_max")
#glimpse(temp_max_anura_present)
...
temp_range_birds_present <- df_merge_birds_past %>% 
  mutate(Bio01_range_past = as.numeric(Bio01_past_max) - as.numeric(Bio01_past_min)) %>%
  mutate(Bio01_range_past = as.numeric(Bio01_past_max) - as.numeric(Bio01_past_min)) %>%
  mutate(Bio04_range_past = as.numeric(Bio04_past_max) - as.numeric(Bio04_past_min)) %>%
  mutate(Bio07_range_past = as.numeric(Bio07_past_max) - as.numeric(Bio07_past_min)) %>%
...
# min
temp_min_mammals_past <- lets.summarizer2(mammals_temp_min_past,  pos = 1049:1054, fun = min) 
colnames(temp_min_mammals_present) <- c("Species", "Bio01_past_min", "Bio04_past_min", "Bio07_past_min",
                                 "Bio11_past_min", "Bio15_past_min", "Bio17_past_min")
# max
temp_max_mammals_past <- lets.summarizer2(mammals_temp_max_past,  pos = 1049:1054, fun = max) 
colnames(temp_max_mammals_present) <- c("Species", "Bio01_past_max", "Bio04_past_max", "Bio07_past_max",
                                 "Bio11_past_max", "Bio15_past_max", "Bio17_past_max")
#glimpse(temp_max_anura_present)
...
temp_range_mammals_present <- df_merge_mammals_past %>% 
  mutate(Bio01_range_past = as.numeric(Bio01_past_max) - as.numeric(Bio01_past_min)) %>%
  mutate(Bio01_range_past = as.numeric(Bio01_past_max) - as.numeric(Bio01_past_min)) %>%
  mutate(Bio04_range_past = as.numeric(Bio04_past_max) - as.numeric(Bio04_past_min)) %>%
  mutate(Bio07_range_past = as.numeric(Bio07_past_max) - as.numeric(Bio07_past_min)) %>%
...
# save niche breadth
write.table(temp_range_anura_past, "climate_data/climate_niche_range_amphibia_past.txt", 
            sep=",", quote=FALSE, row.names = F)
write.table(temp_range_birds_past, "climate_data/climate_niche_range_birds_past.txt", 
            sep=",", quote=FALSE, row.names = F)
write.table(temp_range_squamata_past, "climate_data/climate_niche_range_squamata_past.txt", 
            sep=",", quote=FALSE, row.names = F)
write.table(temp_range_mammals_past, "climate_data/climate_niche_range_mammals_past.txt", 
            sep=",", quote=FALSE, row.names = F)
