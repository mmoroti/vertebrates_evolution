...
```{r}
setwd("E:/repos/vertebrates_evolution")
###--- Amphibia
...
```{r}
# Match species list with phylogeny
squamata_phy <- prune.sample(squamata_list_af, squamata_phy_all)
#plot(amphibia_phy, type= "fan", show.tip.label = FALSE)
...
###
tree_subset(squamata_phy_all, node=anc_squa)
```
...
Herein, we used species dataset (phy + traits) without missing data for calculing evolution model \#### 3.1. Select best fit evolution model \
...
input_traits_amp <- as.data.frame(input_traits_amp) %>%
  rename(body_size_log = input_traits_amp)
```
...
#p_OU$anc_recon[1:20,] # Data with imputed species means
#p_OU$anc_var[1:20,] # Variances for each estimate
input_traits_mammals <- p_OU$anc_recon[1:3853,]
...
# amphibia
write.tree(anura_traits_phy, "02_metrics/full_data/amphibia_fully.tre") 
write.table(input_traits_amp, "02_metrics/full_data/amphibia_traits_fully.txt") 

# squamata
write.tree(squamata_traits_phy, "02_metrics/full_data/squamata_fully.tre") 
write.table(squamata_traits_with_phylogeny, "02_metrics/full_data/squamata_traits_fully.txt") 

# birds
write.tree(birds_traits_phy, "02_metrics/full_data/birds_fully.tre") 
write.table(birds_traits_select, "02_metrics/full_data/birds_traits_fully.txt") 

# mammals
write.tree(mammals_traits_phy, "02_metrics/full_data/mammals_fully.tre") 
write.table(input_traits_mammals, "02_metrics/full_data/mammals_traits_fully.txt") 

# Harmonized dataset
# with excluded species with NA's in body size/body mass
# amphibia
write.tree(anura_traits_phy_without_na, "02_metrics/harmonized_data/amphibia_harm.tre") 
write.table(anura_traits_with_phylogeny_without_na, "02_metrics/harmonized_data/amphibia_traits_harm.txt") 

# mammals
write.tree(mammals_traits_phy_without_na, "02_metrics/harmonized_data/mammals_harm.tre") 
write.table(mammals_traits_with_phylogeny_without_na, "02_metrics/harmonized_data/mammals_traits_harm.txt") 
```
